...
;;
;; Local patch (emacs-config): added (require 'ring) and declare-function for
;; optional evil/persp-mode functions to silence native-compiler warnings.
;;
...
;; Optional integrations — declare so the native compiler doesn't warn.
(declare-function evil-visual-state-p "evil-states" nil)
(declare-function get-current-persp "persp-mode" nil)
